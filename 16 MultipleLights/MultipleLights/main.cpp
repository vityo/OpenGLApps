...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glUniform3f(glGetUniformLocation(shader.program, "dirLight.ambient"), 0.25f, 0.25f, 0.25f);
		...
		for (int i = 0; i < lightCount; ++i) {
			std::string structLocation = "pointLights[" + std::to_string(i) +"].";
			glUniform3f(glGetUniformLocation(shader.program, (structLocation + "position").c_str()), pointLightPositions[i].x, pointLightPositions[i].y, pointLightPositions[i].z);
			glUniform1f(glGetUniformLocation(shader.program, (structLocation + "constant").c_str()), 1.0f);
			glUniform1f(glGetUniformLocation(shader.program, (structLocation + "linear").c_str()), 0.09);
			glUniform1f(glGetUniformLocation(shader.program, (structLocation + "quadratic").c_str()), 0.032);
			glUniform3f(glGetUniformLocation(shader.program, (structLocation + "ambient").c_str()), 0.25f, 0.25f, 0.25f);
			glUniform3f(glGetUniformLocation(shader.program, (structLocation + "diffuse").c_str()), 0.5f, 0.5f, 0.5f);
			glUniform3f(glGetUniformLocation(shader.program, (structLocation + "specular").c_str()), 1.0f, 1.0f, 1.0f);
		}
		...
		glUniform1f(glGetUniformLocation(shader.program, "spotStrength"), 2.0f);
